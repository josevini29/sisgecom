...
public class ListaAjustEstoqControl implements Initializable {
    ...
    public void atualizaGrid() {
        ...
        try {
            ...
            for (Object obj : ajustes) {
                ...
                classeGenerica.setTpAjuste(EstoqueControl.getTipoAjusteEstoque(ajus.getTpAjuste()).getDsTpAjuste());
